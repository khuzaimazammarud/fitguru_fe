...
const FoodView = ({ navigation, route }) => {
    ...
    const calculateDonutData = () => {
        const TotalNut = food.food.nutrients.CHOCDF + food.food.nutrients.PROCNT + food.food.nutrients.FAT + food.food.nutrients.FIBTG;
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.contentContainer}>
                    <Image
                        source={food.food.image ? { uri: food.food.image } : imagePath.placeHolder}
                        style={styles.image}
                    />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', flexWrap: 'wrap', alignItems: 'center', marginVertical: verticalScale(15), }}>
                    {donutData.map((p, i) => {
                        return <Donut
                            key={i}
                ...
                <View style={styles.table}>
                    <NutrientTable label={'Protien'} color={'green'} value={food.food.nutrients.PROCNT} />
                    <NutrientTable label={'Carb'} color={'#FFBE61'} value={food.food.nutrients.CHOCDF} />
                    <NutrientTable label={'Fat'} color={'red'} value={food.food.nutrients.FAT} />
                </View>
                <View style={styles.divider} />
                <View style={{ marginVertical: verticalScale(15) }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: verticalScale(15) }}>
                        <Text style={[styles.primaryText, { fontSize: moderateScale(30), fontWeight: 'bold' }]}>
                            Calories
                        </Text>
                        <Text style={[styles.primaryText, { fontSize: moderateScale(30), fontWeight: 'bold' }]}>
                ...
                <View style={styles.AddContainer}>
                    ...
                    <View style={styles.table}>
                        <NutrientTable label={'Kcal'} color={color.maincolor} value={mealLog.kcal} />
                        <NutrientTable label={'Protein'} color={'green'} value={mealLog.protein} />
                        <NutrientTable label={'Carb'} color={'#FFBE61'} value={mealLog.carb} />
